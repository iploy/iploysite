...
<head>
    ...
    <meta property="og:image" content="http://www.iploy.co.uk/images/fb_img.png" />
	...
	-->
    <script src="../js/mootools-core-1.3.2-full-compat-yc.js" language="javascript" type="text/javascript" ></script>
    <script src="../js/ajaxInjectContent.js" language="javascript" type="text/javascript" ></script>
    <script language="javascript" type="text/javascript" >
    window.addEvent('domready', function(){
		injectContent('http://www.iploy.co.uk/_nav.php?prefix=../','headerRight') ;
	});
	</script>
    <link rel="stylesheet" href="../css/navh.css">


    <link rel="shortcut icon" href="http://www.iploy.co.uk/images/favicon.ico">
...
<header id="header">
    ...
    <div id="headerLeft" >
        <h1>
            <a title="Return to iPloy" href="http://www.iploy.co.uk/">{header}</a>
        </h1>
    </div>
    <div id="headerRight" class="header_right" >
    </div>
</header>
...
-->
    ...
    <div id="subnavContainer" >
        <div id="subnav">
            <menu>
                <ul>
                    <li><a href="http://www.iploy.co.uk/advice/" style="background-image:url(http://www.iploy.co.uk/images/icons/employer.png);" >iPloy Employment Advice Home</a></li>
                    <li><a href="#" style="background-image:url(http://www.iploy.co.uk/images/icons/question.png);" >Categories</a>
                    <ul>
                        {showCategories}
                    </ul>
                    </li>
		            <li><a href="http://www.iploy.co.uk/home.php" style="background-image:url(http://www.iploy.co.uk/images/icons/account_sm.png);" >iPloy Account Admin</a></li>
                </ul>
            </menu>
        </div>
    </div>
